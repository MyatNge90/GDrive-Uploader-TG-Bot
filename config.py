...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5876554027:AAGsBChhVHCksZP0Ekg2yq_a-j-U74S22Mo' # Get it from https://t.me/BotFather
    APP_ID = '11045276' # Get it from my.telegram.org/apps
    API_HASH = 'a6c348400700a6c7bac185638015c32f' # Get it from my.telegram.org/apps
    DATABASE_URL = 'postgres://ZingZoi:150719Zz@database-1.cggdv0tyriae.us-west-1.rds.amazonaws.com:5432/mydb' # SQL Database URL / Heroku Postgres URL
class Messages:
